    ...
    <section class="morino-kuni">
        <div class="morino-kuni-content">
            ...
            <div class="morino-kuni-link">
                <a href="<?php echo esc_url(home_url('/glass')); ?>">ガラス工房森のくに</a>
                <a href="<?php echo esc_url(home_url('/restaurant')); ?>">レストランベルンドルフ</a>
                <a href="<?php echo esc_url(home_url('/hotel')); ?>">ホテルベルンドルフ</a>
            </div>
        </div>
    </section>
        ...
        <div class="purpose">
            <div class="purpose__contents">
                ...
                <div class="purpose__item purpose__item--glass">
                    <a class="purpose__link" href="<?php echo esc_url(home_url('/glass')); ?>">
                        <img class="purpose__image_glass" src="<?php echo get_template_directory_uri(); ?>/assets/img/index/創作.png" alt="創作体験">
                    </a>
                    <a class="purpose__label" href="<?php echo esc_url(home_url('/glass')); ?>">ガラス工房森のくに</a>
                </div>

                <div class="purpose__item purpose__item--restaurant">
                    <a class="purpose__link" href="<?php echo esc_url(home_url('/restaurant')); ?>">
                        <img class="purpose__image_restaurant" src="<?php echo get_template_directory_uri(); ?>/assets/img/index/食事.png" alt="レストラン">
                    </a>
                    <a class="purpose__label" href="<?php echo esc_url(home_url('/restaurant')); ?>">レストラン ベルンドルフ</a>
                </div>
