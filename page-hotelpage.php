...
<main id="hotel">
    ...
    <p class="morino-kuni-address">
        チェックイン：<?php echo esc_html($hotel_info['checkin']); ?>　チェックアウト：<?php echo esc_html($hotel_info['checkout']); ?><br />
        ぶどうの湯 営業時間：<?php echo esc_html($hotel_info['bath_hours']); ?>　ホテル玄関門限：<?php echo esc_html($hotel_info['curfew']); ?><br />
